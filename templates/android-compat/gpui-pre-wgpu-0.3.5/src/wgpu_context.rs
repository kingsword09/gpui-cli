...
impl WgpuContext {
    ...
    pub fn instance(display: Box<dyn wgpu::wgt::WgpuHasDisplayHandle>) -> wgpu::Instance {
        ...
        // Older Android emulator SPIR-V parsers reject the WGSL source-language
        // tag emitted by DEBUG. Keep validation enabled without shader debug data.
        #[cfg(target_os = "android")]
        let flags = flags & !wgpu::InstanceFlags::DEBUG;
